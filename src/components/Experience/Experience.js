                        ...
                        <div className="col-lg-12 col-sm-12">
                            <div className="experience__text">
                                ...
                                <div className="link-draw__hover">
                                    ...
                                    <a className="experience__text__link" href="https://source.redhat.com/groups/public/workflow_and_integration_qe/the_test_trove"><strong>Discover More</strong></a>
                                </div>
                            </div>
                        </div>
                    </div>
