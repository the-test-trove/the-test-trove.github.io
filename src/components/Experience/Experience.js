        ...
        <section>
            <div className="extra-container">
                <div className="experience__tittle">
                    <div className="experience__tittle1"><h1>Barcelona, Spain</h1></div>
                    <h3 id="counting" class="tittle-eff2">26 - 28</h3>
                    <div className="experience__tittle2"><h1>December, 2019</h1></div>
                </div>
            </div>
