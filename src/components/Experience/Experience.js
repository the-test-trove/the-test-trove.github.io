            ...
            <div className="experience">
                <div className="extra-container">
                    <div className="row">
                        ...
                        <div className="col-lg-6 col-sm-6">
                            <a href="https://source.redhat.com/groups/public/workflow_and_integration_qe/the_test_trove/t3con_q1_2021_is_here_join_us_on_feb_23_2021">
                    ...
                    <div className="row">
                        <div className="col-xl-3 col-lg-4 col-sm-6">
                            <a href="https://source.redhat.com/groups/public/workflow_and_integration_qe/the_test_trove/the_test_trove_conferencet3con_q2_may_26_2021" class="experience__thumb experience__thumb--left movein-ex--3">
                        ...
                        <div className="col-xl-6 col-lg-4 col-sm-12">
                            <div className="experience__text">
                                ...
                                <div className="link-draw__hover">
                                    ...
                                    <a class="experience__text__link" href="https://source.redhat.com/groups/public/workflow_and_integration_qe/the_test_trove"><strong>Discover More</strong></a>
                                </div>
                            </div>
                        </div>
                        <div className="col-xl-3 col-lg-4 col-sm-6">
                            <a href="https://source.redhat.com/groups/public/workflow_and_integration_qe/the_test_trove/the_test_trove_conferencet3con_q3_august_26_2021" class="experience__thumb experience__thumb--middle movein-ex--4">
